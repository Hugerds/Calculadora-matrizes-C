...
void trocaLinha(int qLinha, int qColuna, double vet[lin][col], int X, int Y) {
	...
	system("cls");
	gotoxy(1,2); printf ("Sua matriz com a linha %d trocada pela linha %d é:\n", X, Y);
...
void trocaColuna(int qLinha, int qColuna, double vet[lin][col], int X, int Y) {
	...
	int pX, pY, pLinha, pColuna, a1, a2;
	system("cls");
	gotoxy(1,2); printf ("Sua matriz com a coluna %d trocada pela coluna %d é:\n", X, Y);
	for(pLinha=0;pLinha<qLinha;pLinha++) {
        for(pColuna=0;pColuna<qColuna;pColuna++) {
            a1 = vet[pLinha][Y];
            a2 = vet[pLinha][X];
    ...
    gotoxy(1,2); printf ("Sua matriz é:\n");
	for(pY=4, pLinha=0;pLinha<qLinha;pY+=2, pLinha++) {
        for(pX=2, pColuna=0;pColuna<qColuna;pColuna++, pX+=3) {
            gotoxy(pX,pY);
            printf("%.0lf", vet[pLinha][pColuna]);
...
void trocaDiagonal(int qLinha, int qColuna, double vet[lin][col], int X, int Y) {
	...
	system("cls");
        ...
        gotoxy(1,2); printf ("Sua matriz com a digonal primária trocada pela digonal secundária é:\n");
		for(pY=4, pLinha=0;pLinha<qLinha;pY+=2, pLinha++) {
	        for(pX=2, pColuna=0;pColuna<qColuna;pColuna++, pX+=3) {
		        gotoxy(pX,pY);
		        printf("%.0lf", vet[pLinha][pColuna]);
...
int main() {
    ...
    while(sair){
        ...
        gotoxy(20,11); printf("5 - TROCAR DIAGONAL PRINCIPAL POR SECUNDÁRIA");
        gotoxy(20,12); printf("6 - VERIFICAR SE A MATRIZ É SIMÉTRICA");
        gotoxy(20,13); printf("7 - VERIFICAR SE A MATRIZ É UM QUADRADO MÁGICO");
        gotoxy(20,14); printf("8 - VERIFICAR SE A MATRIZ É UM QUADRADO LATINO");
        gotoxy(20,15); printf("9 - VERIFICAR SE A MATRIZ É UMA MATRIZ DE PERMUTAÇÃO");
		...
		if(GetAsyncKeyState(VK_RETURN)){
            if (opcao == 1) {
				...
				if (jaFoi == 0) {
					...
					system("cls");
					do {
						printf ("Quantas linhas terá sua matriz: "); scanf ("%d", &qLinha);
						printf ("Quntas colunas terá sua matriz: "); scanf ("%d", &qColuna);
					} while (qLinha > 15 || qLinha < 1 || qColuna < 1 || qColuna > 15);
					system("cls");
					gotoxy(2,1); printf ("Digite os números da matriz desejada...\n");
                    for(pY=4, pLinha=0;pLinha<qLinha;pY+=2, pLinha++) {
                        for(pX=2, pColuna=0;pColuna<qColuna;pColuna++, pX+=3) {
                            gotoxy(pX,pY);
            ...
            if (opcao == 6) {
                ...
                if (jaFoi == 1) {
                	...
                	if (ehS == 1) {
                		printf ("Sua matriz é simétrica\n\n");
                	}
                	if (ehS == 0) {
                		printf ("Sua matriz não é simétrica\n\n");
					}
					printf ("\n\nAperte qualquer tecla para continuar\n");
					getch();
					system("cls");
            ...
            if (opcao == 7) {
                ...
                if (jaFoi == 1) {
					...
					if (qLinha == qColuna) {
		                ...
		                if (ehQm == 1) {
		                	printf ("Sua matriz é um quadrado mágico\n");
		            	}
		            	if (ehQm == 0) {
		                	printf ("Sua matriz não é um quadrado mágico\n");
		            	}
						printf ("\n\nAperte qualquer tecla para continuar\n");
						getch();
						system("cls");
            ...
            if (opcao == 9) {
                ...
                if (jaFoi == 1) {
	                ...
	                if (ehPm == 1) {
	                	printf ("Sua matriz é uma matriz de permutação\n");
					}
					if (ehPm == 0) {
	                	printf ("Sua matriz não é uma matriz de permutação\n");
					}
	                printf ("\n\nAperte qualquer tecla para continuar\n");
					getch();
					system("cls");
